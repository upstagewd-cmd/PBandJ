...
export const startTournament = async (tournamentId: string,
    startTournamentInput: StartTournamentInput, options?: RequestInit): Promise<TournamentFull> => {
  ...
  return customFetch<TournamentFull>(getStartTournamentUrl(tournamentId),
  {
    ...
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(startTournamentInput)
  }
);}
...
export const getStartTournamentMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof startTournament>>, TError,{tournamentId: string;data: BodyType<StartTournamentInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof startTournament>>, TError,{tournamentId: string;data: BodyType<StartTournamentInput>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof startTournament>>, {tournamentId: string;data: BodyType<StartTournamentInput>}> = (props) => {
          const {tournamentId,data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type StartTournamentMutationBody = BodyType<StartTournamentInput>
    ...
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof startTournament>>, TError,{tournamentId: string;data: BodyType<StartTournamentInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
        ...
        TError,
        {tournamentId: string;data: BodyType<StartTournamentInput>},
        TContext
      > => {
