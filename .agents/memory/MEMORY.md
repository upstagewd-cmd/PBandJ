...
- [ELO + open play architecture](elo-open-play.md) — ELO updates happen in matches.ts on completion; loser auto-joins open_play_pool when eliminated from LB or GF
